...
contract ProfileImageNfts is ERC721, Ownable {
    ...
    using Strings for uint256; //Go back and forth from uint256 to Strings
    ...
    function getAlltoken() public view returns (RenderToken[] memory) {
        ...
        RenderToken[] memory res = new RenderToken[](latestId); //size of new RenderToken[] = latestId
